...
points = {}
csvfile = open('E:/workspace/last mile solution/new_1.csv','rU')
...
csvfile.close()
csvfile = file('E:/workspace/last mile solution/new_2.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
	sInd,lng,lat = line
	if lng=='Lng':
	...
	points[sInd].extend([float(lng),float(lat)])
csvfile.close()
csvfile = file('E:/workspace/last mile solution/new_3.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
	sInd,lng,lat = line
	if lng=='Lng':
...
csvfile.close()
orders={}
csvfile = file('E:/workspace/last mile solution/new_4.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
...
csvfile.close()
csvfile = file('E:/workspace/last mile solution/new_5.csv','rU')
lines = csv.reader(csvfile)
for line in lines:
...
# ------------- loading solution ------------
solution = {}
csvfile = file('E:/workspace/last mile solution/solution_all.csv','rU') # please input your solution path
lines = csv.reader(csvfile)
for line in lines:
